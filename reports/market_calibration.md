...
|------|-------|-------------|
| market_reconciled | 3 | Market + model blend (default publish) |
| market_implied | 0 | Pure market PMF, no model |
| pure_model | 0 | Model only, no odds available |

**Matches with correct-score odds**: 3
...
**2026 predictions generated**: 3 named matches
  market_reconciled: 3
  with correct-score data: 3
  correct-score vendors breakdown: 1-vendor=3, 2+vendors=0

## Vendors
fanduel, draftkings, betmgm, betrivers, caesars, fanatics (593 total rows)