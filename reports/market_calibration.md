...
|------|-------|-------------|
| market_reconciled | 56 | Market + model blend (default publish) |
| market_implied | 0 | Pure market PMF, no model |
| pure_model | 0 | Model only, no odds available |

**Matches with correct-score odds**: 54
...
**2026 predictions generated**: 56 named matches
  market_reconciled: 56
  with correct-score data: 54
  correct-score vendors breakdown: 1-vendor=54, 2+vendors=0

## Vendors
fanduel, draftkings, betmgm, betrivers, caesars, fanatics (363 total rows)