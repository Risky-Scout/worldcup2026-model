...
|------|-------|-------------|
| market_reconciled | 18 | Market + model blend (default publish) |
| market_implied | 0 | Pure market PMF, no model |
| pure_model | 0 | Model only, no odds available |

**Matches with correct-score odds**: 18
...
**2026 predictions generated**: 18 named matches
  market_reconciled: 18
  with correct-score data: 18
  correct-score vendors breakdown: 1-vendor=18, 2+vendors=0

## Vendors
fanduel, draftkings, betmgm, betrivers, caesars, fanatics (432 total rows)