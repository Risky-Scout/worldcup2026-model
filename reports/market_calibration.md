...
|------|-------|-------------|
| market_reconciled | 4 | Market + model blend (default publish) |
| market_implied | 0 | Pure market PMF, no model |
| pure_model | 0 | Model only, no odds available |

**Matches with correct-score odds**: 4
...
**2026 predictions generated**: 4 named matches
  market_reconciled: 4
  with correct-score data: 4
  correct-score vendors breakdown: 1-vendor=4, 2+vendors=0

## Vendors
fanduel, draftkings, betmgm, betrivers, caesars, fanatics (584 total rows)