...
|------|-------|-------------|
| market_reconciled | 54 | Market + model blend (default publish) |
| market_implied | 0 | Pure market PMF, no model |
| pure_model | 0 | Model only, no odds available |

**Matches with correct-score odds**: 52
...
**2026 predictions generated**: 54 named matches
  market_reconciled: 54
  with correct-score data: 52
  correct-score vendors breakdown: 1-vendor=52, 2+vendors=0

## Vendors
fanduel, draftkings, betmgm, betrivers, caesars, fanatics (365 total rows)