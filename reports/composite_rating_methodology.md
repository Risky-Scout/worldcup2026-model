...
|--------|--------|--------------|
| market_implied_attack | 2.703 | 0.447 |
| market_implied_defense | 0.456 | 1.905 |
| final_attack_lambda | 1.950 | 1.089 |
| final_defense_lambda | 0.666 | 1.526 |
| composite lambda_h | **1.661** | — |
| composite lambda_a | — | **2.128** |
