...
|--------|--------|--------------|
| market_implied_attack | 2.197 | 0.650 |
| market_implied_defense | 0.680 | 2.342 |
| final_attack_lambda | 2.174 | 0.886 |
| final_defense_lambda | 0.793 | 2.228 |
| composite lambda_h | **1.268** | — |
| composite lambda_a | — | **1.453** |
