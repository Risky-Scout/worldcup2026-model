...
|--------|--------|--------------|
| market_implied_attack | 2.529 | 0.801 |
| market_implied_defense | 0.315 | 1.466 |
| final_attack_lambda | 2.055 | 0.999 |
| final_defense_lambda | 0.623 | 1.160 |
| composite lambda_h | **2.304** | — |
