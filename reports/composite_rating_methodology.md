...
|--------|--------|--------------|
| market_implied_attack | 2.723 | 0.434 |
| market_implied_defense | 0.419 | 1.839 |
| final_attack_lambda | 1.934 | 1.078 |
| final_defense_lambda | 0.654 | 1.504 |
| composite lambda_h | **1.671** | — |
| composite lambda_a | — | **2.144** |
