...
|--------|--------|--------------|
| market_implied_attack | 2.202 | 0.651 |
| market_implied_defense | 0.675 | 2.341 |
| final_attack_lambda | 2.144 | 0.874 |
| final_defense_lambda | 0.780 | 2.196 |
| composite lambda_h | **1.269** | — |
| composite lambda_a | — | **1.456** |
