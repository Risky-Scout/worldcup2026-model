...
|--------|--------|--------------|
| market_implied_attack | 2.702 | 0.447 |
| market_implied_defense | 0.456 | 1.907 |
| final_attack_lambda | 1.938 | 1.082 |
| final_defense_lambda | 0.662 | 1.516 |
| composite lambda_h | **1.662** | — |
| composite lambda_a | — | **2.126** |
