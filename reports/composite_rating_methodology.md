...
|--------|--------|--------------|
| market_implied_attack | 2.696 | 0.445 |
| market_implied_defense | 0.454 | 1.917 |
| final_attack_lambda | 1.958 | 1.097 |
| final_defense_lambda | 0.668 | 1.533 |
| composite lambda_h | **1.661** | — |
| composite lambda_a | — | **2.133** |
