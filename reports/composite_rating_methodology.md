...
|--------|--------|--------------|
| market_implied_attack | 2.699 | 0.456 |
| market_implied_defense | 0.459 | 1.903 |
| final_attack_lambda | 1.934 | 1.083 |
| final_defense_lambda | 0.660 | 1.513 |
| composite lambda_h | **1.661** | — |
| composite lambda_a | — | **2.134** |
