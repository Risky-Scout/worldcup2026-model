...
|--------|--------|--------------|
| market_implied_attack | 2.508 | 0.801 |
| market_implied_defense | 0.441 | 1.466 |
| final_attack_lambda | 2.001 | 1.003 |
| final_defense_lambda | 0.648 | 1.161 |
| composite lambda_h | **2.239** | — |
