...
|--------|--------|--------------|
| market_implied_attack | 3.030 | 0.977 |
| market_implied_defense | 0.194 | 1.431 |
| final_attack_lambda | 2.117 | 1.162 |
| final_defense_lambda | 0.613 | 1.188 |
| composite lambda_h | **2.316** | — |
| composite lambda_a | — | **2.466** |
