...
|--------|--------|--------------|
| market_implied_attack | 2.201 | 0.651 |
| market_implied_defense | 0.676 | 2.341 |
| final_attack_lambda | 2.142 | 0.873 |
| final_defense_lambda | 0.779 | 2.194 |
| composite lambda_h | **1.270** | — |
| composite lambda_a | — | **1.457** |
