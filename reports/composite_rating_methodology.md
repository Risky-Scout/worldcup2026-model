...
| final_attack_lambda | 1.961 | 0.989 |
| final_defense_lambda | 0.675 | 1.146 |
| composite lambda_h | **2.224** | — |
| composite lambda_a | — | **1.905** |
| composite PMF home_win | **0.460** | (was 0.234 with elo_prior_blend) |
| BDL market home_win | **0.675** | |
| composite vs market gap | 0.215 | (was 0.441 with elo) |