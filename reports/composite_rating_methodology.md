...
| final_attack_lambda | 2.091 | 1.056 |
| final_defense_lambda | 0.776 | 1.188 |
| composite lambda_h | **2.289** | — |
| composite lambda_a | — | **1.768** |
| composite PMF home_win | **0.499** | (was 0.234 with elo_prior_blend) |
| BDL market home_win | **0.675** | |
| composite vs market gap | 0.176 | (was 0.441 with elo) |