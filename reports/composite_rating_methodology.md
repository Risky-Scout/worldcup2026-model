...
|--------|--------|--------------|
| market_implied_attack | 2.700 | 0.455 |
| market_implied_defense | 0.457 | 1.906 |
| final_attack_lambda | 1.883 | 1.054 |
| final_defense_lambda | 0.641 | 1.472 |
| composite lambda_h | **1.663** | — |
| composite lambda_a | — | **2.136** |
