...
|--------|--------|--------------|
| market_implied_attack | 2.664 | 0.445 |
| market_implied_defense | 0.471 | 1.916 |
| final_attack_lambda | 1.823 | 0.951 |
| final_defense_lambda | 0.731 | 1.726 |
| composite lambda_h | **1.373** | — |
