...
|--------|--------|--------------|
| market_implied_attack | 2.531 | 0.801 |
| market_implied_defense | 0.318 | 1.466 |
| final_attack_lambda | 2.062 | 1.003 |
| final_defense_lambda | 0.626 | 1.164 |
| composite lambda_h | **2.303** | — |
| composite lambda_a | — | **2.082** |
