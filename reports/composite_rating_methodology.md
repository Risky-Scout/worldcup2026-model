...
|--------|--------|--------------|
| market_implied_attack | 2.202 | 0.649 |
| market_implied_defense | 0.675 | 2.345 |
| final_attack_lambda | 2.018 | 0.821 |
| final_defense_lambda | 0.734 | 2.068 |
| composite lambda_h | **1.269** | — |
| composite lambda_a | — | **1.455** |
| composite PMF home_win | **0.329** | (was 0.234 with elo_prior_blend) |
| BDL market home_win | **0.675** | |
| composite vs market gap | 0.346 | (was 0.441 with elo) |