...
|--------|--------|--------------|
| market_implied_attack | 2.243 | 0.452 |
| market_implied_defense | 0.706 | 1.927 |
| final_attack_lambda | 2.028 | 1.055 |
| final_defense_lambda | 0.987 | 1.778 |
| composite lambda_h | **1.483** | — |
| composite lambda_a | — | **1.390** |
