...
|--------|--------|--------------|
| market_implied_attack | 2.500 | 0.801 |
| market_implied_defense | 0.448 | 1.466 |
| final_attack_lambda | 2.007 | 1.006 |
| final_defense_lambda | 0.651 | 1.166 |
| composite lambda_h | **2.239** | — |
| composite lambda_a | — | **2.008** |
