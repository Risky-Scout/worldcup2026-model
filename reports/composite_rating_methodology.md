...
|--------|--------|--------------|
| market_implied_attack | 2.207 | 0.651 |
| market_implied_defense | 0.677 | 2.341 |
| final_attack_lambda | 1.782 | 0.816 |
| final_defense_lambda | 0.764 | 1.741 |
| composite lambda_h | **1.330** | — |
| composite lambda_a | — | **1.388** |
| composite PMF home_win | **0.358** | (was 0.234 with elo_prior_blend) |
| BDL market home_win | **0.675** | |
| composite vs market gap | 0.317 | (was 0.441 with elo) |