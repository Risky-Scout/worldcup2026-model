...
|--------|--------|--------------|
| market_implied_attack | 2.207 | 0.652 |
| market_implied_defense | 0.677 | 2.340 |
| final_attack_lambda | 1.712 | 0.857 |
| final_defense_lambda | 0.816 | 1.678 |
| composite lambda_h | **1.327** | — |
| composite lambda_a | — | **1.365** |
