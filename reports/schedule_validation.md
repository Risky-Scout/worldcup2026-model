...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 56 | Excludes TBD knockouts |
| With BDL odds (1X2) | 56 | ≥1 vendor |
| With correct-score odds | 54 | Used in KL reconciliation |
| Published as market_reconciled | 56 | Default publish mode |
