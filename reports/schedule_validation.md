...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 47 | Excludes TBD knockouts |
| With BDL odds (1X2) | 47 | ≥1 vendor |
| With correct-score odds | 47 | Used in KL reconciliation |
| Published as market_reconciled | 47 | Default publish mode |
