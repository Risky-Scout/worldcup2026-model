...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 70 | Excludes TBD knockouts |
| With BDL odds (1X2) | 70 | ≥1 vendor |
| With correct-score odds | 70 | Used in KL reconciliation |
| Published as market_reconciled | 70 | Default publish mode |
