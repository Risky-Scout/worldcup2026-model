...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 67 | Excludes TBD knockouts |
| With BDL odds (1X2) | 67 | ≥1 vendor |
| With correct-score odds | 67 | Used in KL reconciliation |
| Published as market_reconciled | 67 | Default publish mode |
