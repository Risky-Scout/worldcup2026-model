...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 48 | Excludes TBD knockouts |
| With BDL odds (1X2) | 48 | ≥1 vendor |
| With correct-score odds | 48 | Used in KL reconciliation |
| Published as market_reconciled | 48 | Default publish mode |
