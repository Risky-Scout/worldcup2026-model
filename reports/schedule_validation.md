...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 66 | Excludes TBD knockouts |
| With BDL odds (1X2) | 66 | ≥1 vendor |
| With correct-score odds | 66 | Used in KL reconciliation |
| Published as market_reconciled | 66 | Default publish mode |
