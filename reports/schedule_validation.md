...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 61 | Excludes TBD knockouts |
| With BDL odds (1X2) | 61 | ≥1 vendor |
| With correct-score odds | 60 | Used in KL reconciliation |
| Published as market_reconciled | 61 | Default publish mode |
