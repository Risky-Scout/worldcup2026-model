...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 32 | Excludes TBD knockouts |
| With BDL odds (1X2) | 32 | ≥1 vendor |
| With correct-score odds | 31 | Used in KL reconciliation |
| Published as market_reconciled | 32 | Default publish mode |
