...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 38 | Excludes TBD knockouts |
| With BDL odds (1X2) | 38 | ≥1 vendor |
| With correct-score odds | 38 | Used in KL reconciliation |
| Published as market_reconciled | 38 | Default publish mode |
