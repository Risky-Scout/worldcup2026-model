...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 18 | Excludes TBD knockouts |
| With BDL odds (1X2) | 18 | ≥1 vendor |
| With correct-score odds | 18 | Used in KL reconciliation |
| Published as market_reconciled | 18 | Default publish mode |
