...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 57 | Excludes TBD knockouts |
| With BDL odds (1X2) | 57 | ≥1 vendor |
| With correct-score odds | 55 | Used in KL reconciliation |
| Published as market_reconciled | 57 | Default publish mode |
