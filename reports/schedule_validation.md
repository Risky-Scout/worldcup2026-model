...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 60 | Excludes TBD knockouts |
| With BDL odds (1X2) | 60 | ≥1 vendor |
| With correct-score odds | 59 | Used in KL reconciliation |
| Published as market_reconciled | 60 | Default publish mode |
