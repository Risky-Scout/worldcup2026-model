...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 37 | Excludes TBD knockouts |
| With BDL odds (1X2) | 37 | ≥1 vendor |
| With correct-score odds | 36 | Used in KL reconciliation |
| Published as market_reconciled | 37 | Default publish mode |
