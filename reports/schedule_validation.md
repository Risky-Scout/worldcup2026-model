...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 31 | Excludes TBD knockouts |
| With BDL odds (1X2) | 31 | ≥1 vendor |
| With correct-score odds | 30 | Used in KL reconciliation |
| Published as market_reconciled | 31 | Default publish mode |
