...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 34 | Excludes TBD knockouts |
| With BDL odds (1X2) | 34 | ≥1 vendor |
| With correct-score odds | 33 | Used in KL reconciliation |
| Published as market_reconciled | 34 | Default publish mode |
