...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 58 | Excludes TBD knockouts |
| With BDL odds (1X2) | 58 | ≥1 vendor |
| With correct-score odds | 58 | Used in KL reconciliation |
| Published as market_reconciled | 58 | Default publish mode |
