...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 35 | Excludes TBD knockouts |
| With BDL odds (1X2) | 35 | ≥1 vendor |
| With correct-score odds | 34 | Used in KL reconciliation |
| Published as market_reconciled | 35 | Default publish mode |
