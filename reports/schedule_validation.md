...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 29 | Excludes TBD knockouts |
| With BDL odds (1X2) | 29 | ≥1 vendor |
| With correct-score odds | 28 | Used in KL reconciliation |
| Published as market_reconciled | 29 | Default publish mode |
