...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 63 | Excludes TBD knockouts |
| With BDL odds (1X2) | 63 | ≥1 vendor |
| With correct-score odds | 63 | Used in KL reconciliation |
| Published as market_reconciled | 63 | Default publish mode |
