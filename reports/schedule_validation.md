...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 28 | Excludes TBD knockouts |
| With BDL odds (1X2) | 28 | ≥1 vendor |
| With correct-score odds | 27 | Used in KL reconciliation |
| Published as market_reconciled | 28 | Default publish mode |
