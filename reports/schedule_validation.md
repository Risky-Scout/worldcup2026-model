...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 53 | Excludes TBD knockouts |
| With BDL odds (1X2) | 53 | ≥1 vendor |
| With correct-score odds | 51 | Used in KL reconciliation |
| Published as market_reconciled | 53 | Default publish mode |
