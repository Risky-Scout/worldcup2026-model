...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 54 | Excludes TBD knockouts |
| With BDL odds (1X2) | 54 | ≥1 vendor |
| With correct-score odds | 52 | Used in KL reconciliation |
| Published as market_reconciled | 54 | Default publish mode |
