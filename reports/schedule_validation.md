...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 42 | Excludes TBD knockouts |
| With BDL odds (1X2) | 42 | ≥1 vendor |
| With correct-score odds | 42 | Used in KL reconciliation |
| Published as market_reconciled | 42 | Default publish mode |
