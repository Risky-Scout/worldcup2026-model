...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 22 | Excludes TBD knockouts |
| With BDL odds (1X2) | 22 | ≥1 vendor |
| With correct-score odds | 21 | Used in KL reconciliation |
| Published as market_reconciled | 22 | Default publish mode |
