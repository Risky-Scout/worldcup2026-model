...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 8 | Excludes TBD knockouts |
| With BDL odds (1X2) | 8 | ≥1 vendor |
| With correct-score odds | 8 | Used in KL reconciliation |
| Published as market_reconciled | 8 | Default publish mode |
