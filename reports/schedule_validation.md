...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 45 | Excludes TBD knockouts |
| With BDL odds (1X2) | 45 | ≥1 vendor |
| With correct-score odds | 45 | Used in KL reconciliation |
| Published as market_reconciled | 45 | Default publish mode |
