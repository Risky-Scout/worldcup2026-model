...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 64 | Excludes TBD knockouts |
| With BDL odds (1X2) | 64 | ≥1 vendor |
| With correct-score odds | 64 | Used in KL reconciliation |
| Published as market_reconciled | 64 | Default publish mode |
