...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 33 | Excludes TBD knockouts |
| With BDL odds (1X2) | 33 | ≥1 vendor |
| With correct-score odds | 32 | Used in KL reconciliation |
| Published as market_reconciled | 33 | Default publish mode |
