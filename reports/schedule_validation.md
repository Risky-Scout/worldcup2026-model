...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 44 | Excludes TBD knockouts |
| With BDL odds (1X2) | 44 | ≥1 vendor |
| With correct-score odds | 44 | Used in KL reconciliation |
| Published as market_reconciled | 44 | Default publish mode |
