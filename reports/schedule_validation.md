...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 36 | Excludes TBD knockouts |
| With BDL odds (1X2) | 36 | ≥1 vendor |
| With correct-score odds | 35 | Used in KL reconciliation |
| Published as market_reconciled | 36 | Default publish mode |
