...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 40 | Excludes TBD knockouts |
| With BDL odds (1X2) | 40 | ≥1 vendor |
| With correct-score odds | 40 | Used in KL reconciliation |
| Published as market_reconciled | 40 | Default publish mode |
