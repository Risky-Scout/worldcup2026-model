...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 24 | Excludes TBD knockouts |
| With BDL odds (1X2) | 24 | ≥1 vendor |
| With correct-score odds | 22 | Used in KL reconciliation |
| Published as market_reconciled | 24 | Default publish mode |
