...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 15 | Excludes TBD knockouts |
| With BDL odds (1X2) | 15 | ≥1 vendor |
| With correct-score odds | 15 | Used in KL reconciliation |
| Published as market_reconciled | 15 | Default publish mode |
