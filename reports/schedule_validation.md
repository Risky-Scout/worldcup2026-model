...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 25 | Excludes TBD knockouts |
| With BDL odds (1X2) | 25 | ≥1 vendor |
| With correct-score odds | 23 | Used in KL reconciliation |
| Published as market_reconciled | 25 | Default publish mode |
