...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 39 | Excludes TBD knockouts |
| With BDL odds (1X2) | 39 | ≥1 vendor |
| With correct-score odds | 39 | Used in KL reconciliation |
| Published as market_reconciled | 39 | Default publish mode |
