...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 9 | Excludes TBD knockouts |
| With BDL odds (1X2) | 9 | ≥1 vendor |
| With correct-score odds | 9 | Used in KL reconciliation |
| Published as market_reconciled | 9 | Default publish mode |
