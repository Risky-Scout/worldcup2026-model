...
| Category | Count | Note |
|----------|-------|------|
| Named matches predicted | 27 | Excludes TBD knockouts |
| With BDL odds (1X2) | 27 | ≥1 vendor |
| With correct-score odds | 25 | Used in KL reconciliation |
| Published as market_reconciled | 27 | Default publish mode |
