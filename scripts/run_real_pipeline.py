...
def _predict_one_match(
    ...
    return {
        ...
        "prediction": {
            ...
            "home_win_prob": round(float(publish_markets.get("home_win", 0.0)), 6),
            "draw_prob": round(float(publish_markets.get("draw", 0.0)), 6),
            "away_win_prob": round(float(publish_markets.get("away_win", 0.0)), 6),
            "publish_mode": rec.publish_mode,
